...
function useSearchProductPaginationHook<T>({
  apiUrl,
  limit,
  extraParams
  ...
  const fetchData = async (page: number, updatedParams = params) => {
    ...
    try {
      const response = await axios.get(apiUrl, {
        params: { page, limit, ...updatedParams },
      });
  ...
  return { data, resetAndFetchData: setSortBy, loading, updateParams };
}

export default useSearchProductPaginationHook;
